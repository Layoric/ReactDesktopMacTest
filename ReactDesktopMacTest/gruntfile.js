...
module.exports = function (grunt) {
    ...
    var resourcesRoot = '../ReactDesktopMacTest.Resources/';
    var webRoot = 'wwwroot/';
    ...
    grunt.initConfig({
        ...
        msbuild: {
            'release-console': {
                src: ['../ReactDesktopMacTest.AppConsole/ReactDesktopMacTest.AppConsole.csproj'],
                options: {
            ...
            'release-winforms': {
                src: ['../ReactDesktopMacTest.AppWinForms/ReactDesktopMacTest.AppWinForms.csproj'],
                options: {
                    projectConfiguration: 'Release',
                    targets: ['Clean', 'Rebuild'],
                    stdout: true,
            ...
            'release-webapp': {
                src: ['.\\ReactDesktopMacTest.csproj'],
                options: {
                    projectConfiguration: 'Release',
                    targets: ['Clean', 'Rebuild'],
                    stdout: true,
            ...
            'release-resources': {
                src: ['..\\ReactDesktopMacTest.Resources\\ReactDesktopMacTest.Resources.csproj'],
                options: {
                    projectConfiguration: 'Release',
                    targets: ['Clean', 'Rebuild'],
                    stdout: true,
        ...
        nugetrestore: {
            'restore-console': {
                src: '../ReactDesktopMacTest.AppConsole/packages.config',
                dest: '../../packages/'
            },
            'restore-winforms': {
                src: '../ReactDesktopMacTest.AppWinForms/packages.config',
                dest: '../../packages/'
            },
            'restore-webapp': {
                src: './packages.config',
            ...
            'restore-resources': {
                src: '../ReactDesktopMacTest.Resources/packages.config',
                dest: '../../packages/'
            }
        },
        msdeploy: {
        ...
        gulp: {
            ...
            'copy-resources-lib': function () {
                return gulp.src('../ReactDesktopMacTest.Resources/bin/Release/ReactDesktopMacTest.Resources.dll')
