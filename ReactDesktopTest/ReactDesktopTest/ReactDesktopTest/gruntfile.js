...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        msbuild: {
            'release-console': {
                src: ['../ReactDesktopTest.AppConsole/ReactDesktopTest.AppConsole.csproj'],
                options: {
            ...
            'release-winforms': {
                src: ['../ReactDesktopTest.AppWinForms/ReactDesktopTest.AppWinForms.csproj'],
                options: {
                    projectConfiguration: 'Release',
                    targets: ['Clean', 'Rebuild'],
                    stdout: true,
            ...
            'release-resources': {
                src: ['..\\ReactDesktopTest.Resources\\ReactDesktopTest.Resources.csproj'],
                options: {
                    projectConfiguration: 'Release',
                    targets: ['Clean', 'Rebuild'],
                    stdout: true,
        ...
        nugetrestore: {
            'restore-console': {
                src: '../ReactDesktopTest.AppConsole/packages.config',
                dest: '../../packages/'
            },
            'restore-winforms': {
                src: '../ReactDesktopTest.AppWinForms/packages.config',
                dest: '../../packages/'
            },
            'restore-webapp': {
                src: './packages.config',
            ...
            'restore-resources': {
                src: '../ReactDesktopTest.Resources/packages.config',
                dest: '../../packages/'
            }
        },
        msdeploy: {
        ...
        gulp: {
            ...
            'wwwroot-bundle': function () {
                ...
                return gulp.src('./**/*.cshtml')
                    ...
                    .pipe(assets.restore())
                    .pipe(useref())
                    .pipe(gulpif('*.cshtml',header("@*Auto generated file on " + (new Date().toLocaleString()) + ". See ReactDesktopTest project grunt file*@\r\n")))
