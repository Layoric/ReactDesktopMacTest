...
namespace ReactDesktopTest.AppMac.AppMac
{
	public class AppHost : AppSelfHostBase
	{
		...
		/// </summary>
		public AppHost()
			: base("ReactDesktopTest.AppMac.AppMac.AppMac", typeof(MyServices).Assembly)
		{
		...
		public void ShowAbout()
		{
			...
			MainClass.MainMenu.InvokeOnMainThread (() => {
				foreach (var item in MainClass.MainMenu.ItemArray()) {
					if (item.Title == "ReactDesktopTest.AppMac.AppMac") {
